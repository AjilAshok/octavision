  ...
  Widget build(BuildContext context) {
    return SafeArea(child: Scaffold(
         ...
         const ListTile(
          ...
          ListTile(
              ...
              Get.to(LicensePage(
                ...
                applicationName:"Soul" ,applicationIcon:Image.asset("assets/appicon1.jpeg") ,));
            },
            title: Text("Liscense",style: TextStyle(fontSize: 25),),
            trailing:Icon(Icons.arrow_forward_ios) ,
          ),
            ListTile(
            onTap: (){
      ...
      _showSnackBar(context,"Text copied");
          ...
          Spacer(),
          Center(
            child: Text("Developed By Octavision",style: TextStyle(fontSize: 20),),
          )
        ],
      ) ,
