    ...
    return SafeArea(
      ...
      body: NotificationListener<OverscrollIndicatorNotification>(
              ...
              child: Container(
                ...
                image:const DecorationImage(image: AssetImage("assets/background.jpeg"),fit: BoxFit.cover)
                              ...
                              children: [
                                ...
                                Center(
                                  child: AnimatedTextKit(
                                    ...
                                    animatedTexts: [
                                    ScaleAnimatedText("SOUL", textStyle: TextStyle(fontSize: 40,fontWeight: FontWeight.bold,letterSpacing: 2), ),
                                      ScaleAnimatedText("SOUL", textStyle: TextStyle(fontSize:40,fontWeight: FontWeight.bold,letterSpacing: 2,color: Colors.white ), )
                                  ]),
                                ),
                                GestureDetector(
                                  onTap: (){
